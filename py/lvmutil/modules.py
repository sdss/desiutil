...
def init_modules(moduleshome=None, method=False, command=False):
    ...
    def lvmutil_module(command, *arguments):
        ...
        return
    if method:
        def lvmutil_module_method(self, command, *arguments):
            return lvmutil_module(command, *arguments)
        lvmutil_module_method.__doc__ = lvmutil_module.__doc__
        return lvmutil_module_method
    return lvmutil_module
