...
# -*- coding: utf-8 -*-
"""
lvmutil.test.lvmutil_test_suite
=================================
...
def runtests():
    """Run all tests in lvmutil.test.test_*.
    """
    # Load all TestCase classes from lvmutil/test/test_*.py
    tests = lvmutil_test_suite()
    # Run them
