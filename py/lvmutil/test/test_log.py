...
class TestLog(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Cache LVM_LOGLEVEL if it is set.
        """
        cls.desi_loglevel = None
        if 'LVM_LOGLEVEL' in os.environ:
            cls.desi_loglevel = os.environ['LVM_LOGLEVEL']
            del os.environ['LVM_LOGLEVEL']
    ...
    def tearDownClass(cls):
        """Restore LVM_LOGLEVEL, if necessary.
        """
        if cls.desi_loglevel is not None:
            os.environ['LVM_LOGLEVEL'] = cls.desi_loglevel
    ...
    def run_logs(self, **kwargs):
        ...
        try:
            desi_loglevel = os.environ['LVM_LOGLEVEL']
        except KeyError:
            desi_loglevel = None
    ...
    def test_log_with_desi_loglevel(self):
        """Test basic logging functionality with LVM_LOGLEVEL set.
        """
        for lvl in ('warning', 'foobar'):
            with patch.dict('os.environ', {'LVM_LOGLEVEL': lvl}):
                self.run_logs()
