...
from .. import __version__ as lvmutil_version
...
from lvmutil.setup import DesiModule, DesiTest, DesiVersion, get_version
...
"""
    ...
    def test_get_version(self):
        ...
        os.rmdir(p)
        os.chdir(self.original_dir)
        v = get_version('lvmutil')
        self.assertEqual(v, lvmutil_version)
